      ...
      <div class="col-md-10">
        ...
        <div class="gallery-content">
          ...
          <div class="gallery-content__item pb-5">
            ...
            <div class="gallery-content__small"><a href="images/galeria/foto5.jpg" rel="lightbox[modelos]" title="Blusa Freya"><img src="images/galeria/foto005.jpg" alt=""></a></div>
        ...
        <div class="container-login pt-5">
          <div class="content-login first-content">
            <div class="first-column">
              ...
              <p class="login-modal">Faça login na sua conta</p>
              <button type="button" class="btn btn-login" data-toggle="modal" data-target="#loginModal">Sign in</button>
            </div>
            <!-- Início do Modal -->
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="form-title text-center">
                      <h4 class="title-second">Entre com sua conta</h4>
                    </div>
                    <div class="d-flex flex-column text-center">
                      <form method="post" action="clientes/area-usuario.php">
                        <div class="form-group">
                          <input type="email" class="form-control" id="email" name="email" placeholder="Seu e-mail..."><br>
                        </div>
                        <div class="form-group">
                          <input type="password" class="form-control" id="password" name="senha" placeholder="Sua senha...">
                        </div><br>
                        <button type="submit" class="btn btn-second " data-toggle="modal">Login</button>
                        <?php
                      ...
                      <div class="text-center text-muted delimiter">ou use uma conta já existente</div>
                  ...
                  <div class="modal-footer d-flex justify-content-center">
                    <div class="signup-section">Não tem uma conta? <a href="#meucloset" class="text-info" data-dismiss="modal">Sign Up</a>.</div>
            ...
            <div class="second-column">
              ...
              <p class="description description-second">ou use uma conta já existente:</p>
              <form class="form" name="formulario-login" method="post" action="clientes/area-usuario.php">
                ...
                <label class="label-input" for="">
                  ...
                  <input type="password" inputmode="numeric" minLength="6" maxlength="8" placeholder="Senha*" required name="password">
                </label>
                <label class="label-input">
                  <i class="fab fa-whatsapp icone"></i>
                  <input type="tel" name="telefone" placeholder="Telefone*" required name="telefone">
                </label>
