          ...
          <div class="container-login pt-5">
            <div class="content-login first-content">
              <div class="first-column">
                ...
                <p class="description description-primary">login com uma conta</p>
              ...
              <div class="second-column">
                ...
                <form class="form" name="formulario-login" method="post" action="clientes/cadastro-inserir.php">
                  ...
                  <label class="label-input" for="">
                    ...
                    minLength="6" maxlength="8" placeholder="Senha*" required name="password">                 
                  </label>
